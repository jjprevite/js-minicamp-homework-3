...
function invokeMethod(object, method) {
  ...
  object[method](); //This was tough. I think I used brackets because method is a string and then I forgot to include the paratheses, which made it pass.
}
...
function hasEmail(user) {
  ...
  //This one wasn't too bad, I had to look up the part after the 'and' operator.
...
function hasProperty(object, property) {
  ...
  //otherwise return false
  if (object.hasOwnProperty(property)) { //Some of these are tripping me up as to whether or not I have to use '' when writing it in the function.
    return true;
  } else return false;
}
